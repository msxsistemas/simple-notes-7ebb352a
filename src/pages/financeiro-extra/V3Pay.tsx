...
export default function V3Pay() {
  ...
  useEffect(() => {
    document.title = "V3Pay PF - Gateway de Pagamentos | Gestor IPTV";
  }, []);
      ...
      <header className="rounded-lg border mb-6 overflow-hidden shadow" aria-label="Configuração do V3Pay">
        <div className="px-4 py-3 text-primary-foreground" style={{ background: "var(--gradient-primary)" }}>
          <div className="flex items-center gap-2">
            ...
            <h1 className="text-base font-semibold tracking-tight">Configuração do V3Pay PF</h1>
          </div>
          <p className="text-xs/6 opacity-90">Configure seu gateway V3Pay (Pessoa Física) para receber pagamentos PIX, cartão e boleto.</p>
        </div>
      </header>
        ...
        <section className="grid gap-4 md:grid-cols-2">
          ...
          <Card className="shadow-sm">
            <CardHeader>
              ...
              <CardDescription>
                Acesse o painel V3Pay para obter seu token de API (conta PF).
              </CardDescription>
            </CardHeader>
            <CardContent>
          ...
          <Card className="shadow-sm">
            <CardHeader>
              <div className="flex items-center gap-2">
                ...
                <CardTitle className="text-sm">Token API V3Pay PF</CardTitle>
              </div>
              <CardDescription>
                Cole o token da API do V3Pay (conta Pessoa Física) abaixo para ativar a integração.
              </CardDescription>
            </CardHeader>
            <CardContent>
              <div className="space-y-3">
                <Input
                  ...
                  placeholder="Seu token Bearer da API V3Pay PF..."
              ...
              <div className="flex justify-center border-t pt-4 mt-2">
                <Button onClick={handleConfigure} disabled={loading}>
                  {loading ? "Verificando..." : "Ativar V3Pay PF"}
                </Button>
              </div>
            </CardContent>
          </Card>
